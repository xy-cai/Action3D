                ...
                for f = 3:size(directed_area{a,s,e},1)-2
                    if sum(dataIn(:,f,4))/size(dataIn,1) > 0.4
                        ...
                        for j = 1:size(directed_area{a,s,e},2)
                            feat{a,s,e}(cnt:cnt+2,fcnt-2) = directed_area{a,s,e}{f,j}(1:3);
                            cnt = cnt+3;
                        end
                        for j = 1:size(motion_vector_20_3{a,s,e},2)
                            feat{a,s,e}(cnt:cnt+2,fcnt-2) = motion_vector_20_3{a,s,e}{f,j}(1:3);
                            cnt = cnt+3;
                        end
                        for j = 1:size(relative_pos_57{a,s,e},2)
                            feat{a,s,e}(cnt:cnt+2,fcnt-2) = relative_pos_57{a,s,e}{f,j}(1:3);
                            cnt = cnt+3;
                        end
                        feat{a,s,e}(cnt:cnt+179,fcnt-2) = moving_pose{a,s,e}{f}(1:180);
                        cnt = cnt+180;
                        feat{a,s,e}(cnt:cnt+399,fcnt-2) = motion_vector_20_20{a,s,e}{f}(1:400);
                        cnt = cnt+400;
                        feat{a,s,e}(cnt:cnt+189,fcnt-2) = relations_20_19{a,s,e}{f}(1:190);
                        cnt = cnt+190;
                    end
                    fcnt = fcnt + 1;
                end
