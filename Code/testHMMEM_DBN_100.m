function testHMMEM_DBN_100

%% load quantization feat
load ../result/limb_feat_DBN_100.mat
...
save '../result/mhmm_20_DBN_100.mat' LL HMM;

load ../result/mhmm_20_DBN_100.mat
confmat = zeros(20,20);
for a = 1:20
...
save ../result/testHMMEM_confmat_DBN_100.mat confmat

%% load quantization feat
load ../result/limb_feat_DBN_100_2.mat
...
save '../result/mhmm_20_DBN_100_2.mat' LL HMM;

load ../result/mhmm_20_DBN_100_2.mat
confmat = zeros(20,20);
for a = 1:20
    for j = 1:size(te_hmm{a},1)
        sco = zeros(20,1);
...
save ../result/testHMMEM_confmat_DBN_100_2.mat confmat
