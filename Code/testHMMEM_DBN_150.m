function testHMMEM_DBN_150

%% load quantization feat
load ../result/limb_feat_DBN_150.mat
...
save '../result/mhmm_20_DBN_150.mat' LL HMM;

load ../result/mhmm_20_DBN_150.mat
confmat = zeros(20,20);
for a = 1:20
...
save ../result/testHMMEM_confmat_DBN_150.mat confmat

%% load quantization feat
load ../result/limb_feat_DBN_150_2.mat
...
save '../result/mhmm_20_DBN_150_2.mat' LL HMM;

load ../result/mhmm_20_DBN_150_2.mat
confmat = zeros(20,20);
for a = 1:20
    for j = 1:size(te_hmm{a},1)
        sco = zeros(20,1);
...
save ../result/testHMMEM_confmat_DBN_150_2.mat confmat
